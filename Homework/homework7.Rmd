...
b. A reasonable test statistic in this problem is $\bar{Y} = \frac{1}{19} \sum\limits_{i=1}^{19}(Y_1+Y_2+\dots+Y_{19})$.  Write the sampling distribution of $\bar{Y}$? Be sure to give a brief justification. Also state the values of any parameters (if known).
