...
b. Now implement a parametric bootstrap scheme to approximate the sampling distribution of $\hat{\sigma}^2_0$. Generate $B=1,000$ bootstrapped estimates and save them in a data frame called `boot_df`. Print the first few rows to look at it. (Consult slides 9 - 13 in the slide deck 6.1 - 6.2.)
